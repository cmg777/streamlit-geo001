...
# --- Create Box Plot ---
st.subheader(f"Box Plot of {selected_x_label} by Department")
...
st.sidebar.info(f"Visualizing: Box plot of {selected_x_label} (`{selected_x_col}`) by Department with additional hover data: {selected_add_label}")